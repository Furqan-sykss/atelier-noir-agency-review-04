      ...
      <div className="container">
        <div className="grid grid-cols-12 gap-6">
          <div className="col-span-12 md:col-span-2">
            <span className="eyebrow">06 — Culture</span>
          </div>
          <Reveal className="col-span-12 md:col-span-8 md:col-start-3">
            <h2 className="text-5xl leading-[.95] tracking-[-.05em] md:text-[7vw]">
              We care about the details people <span className="serif italic">don&apos;t notice.</span>
            </h2>
          </Reveal>
        </div>
        <div className="mt-20 grid grid-cols-12 items-end gap-6">
          <ImageReveal src="/images/pexels-kindelmedia-7688336.jpg" alt="Studio placeholder" className="col-span-12 aspect-[4/3] md:col-span-8 md:aspect-[16/10]" />
